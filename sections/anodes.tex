...
\begin{figure}
    ...
    \caption{Li migration pathway in LiC$_{6}$. In the through-plane pathway, lithium migrates through a carbon hexagon hollow (H) along the crystallographic c direction. The in-plane pathways are denoted as bridge (B) and top (T) reproduced with permission from ref.~\citenum{thinius2014theoretical}.}
    \label{fig:Rl}
\end{figure}
